defmodule Fab.Es.Person do
  ...
  @spec do_first_name(:female | :male | :neutral) :: [String.t()]
  ...
  defp do_first_name(:neutral) do
    do_first_name(:female) ++ do_first_name(:male)
  end
  ...
  @spec do_prefix(:female | :male | :neutral) :: [String.t()]
